...
def main() -> None:
    ...
    ap.add_argument("--night", default="raid night",
                    help='phrase for the intro, e.g. "Ragz Raiders progression night"')
    ...
    if args.publish:
        ...
        row = {"slug": slug,
               ...
               "summary": (f"{tok['pulls']} pulls at {tok['difficulty'].lower()} {tok['boss']}: "
                           "the orb rotation and what it costs, the flat absorb behind the "
                           "fifteen-second shield, the ghosts that decide how much of the serpent "
                           "comes back, and the falls that were half the night's deaths."),
